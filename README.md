...
面向电脑浏览器的私人游戏与功能工作区，采用 React、Node.js、PostgreSQL 与服务端权威规则引擎实现。当前“游戏”包含三国杀、固定 6 人 3V3 的山东够级、经典 3 人斗地主、璀璨宝石、璀璨宝石宝可梦、数字炸弹和数字连连看；“功能”包含支持本地 TXT、中文编码、章节识别与技术文档模式的小说阅读器。
