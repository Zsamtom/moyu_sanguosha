...
> = {
  snow_chicken: {
    ...
    purchaseCost: 90, resalePrice: 45, feedCropId: "frost_barley",
    feedAmount: 1, productionSeconds: 11 * MINUTE, yield: 3,
  ...
  ptarmigan: {
    ...
    purchaseCost: 155, resalePrice: 78, feedCropId: "highland_bean",
    feedAmount: 1, productionSeconds: 22 * MINUTE, yield: 3,
  ...
  angora_rabbit: {
    ...
    purchaseCost: 240, resalePrice: 120, feedCropId: "snow_potato",
    feedAmount: 1, productionSeconds: 32 * MINUTE, yield: 3,
  ...
  highland_sheep: {
    ...
    purchaseCost: 390, resalePrice: 195, feedCropId: "frost_barley",
    feedAmount: 2, productionSeconds: 65 * MINUTE, yield: 4,
  ...
  yak: {
    ...
    purchaseCost: 780, resalePrice: 390, feedCropId: "highland_bean",
    feedAmount: 2, productionSeconds: 2 * HOUR, yield: 4,
  ...
  cashmere_goat: {
    ...
    purchaseCost: 1_180, resalePrice: 590, feedCropId: "snow_potato",
    feedAmount: 2, productionSeconds: 3 * HOUR, yield: 5,
...
> = {
  lignite: {
    ...
    durationSeconds: 16 * MINUTE, yield: 3, orePrice: 27,
  ...
  magnetite: {
    ...
    rationProductId: "snow_egg", rationAmount: 1,
    supportProductId: "angora_fur", supportAmount: 1,
    durationSeconds: 32 * MINUTE, yield: 3, orePrice: 41,
  ...
  tin: {
    ...
    durationSeconds: 65 * MINUTE, yield: 4, orePrice: 64,
  ...
  frost_silver: {
    ...
    supportProductId: "highland_wool", supportAmount: 1,
    durationSeconds: 2 * HOUR, yield: 4, orePrice: 101,
  ...
  glacier_gold: {
    ...
    durationSeconds: 3 * HOUR, yield: 4, orePrice: 159,
  ...
  frost_crystal: {
    ...
    supportProductId: "highland_wool", supportAmount: 2,
    durationSeconds: 6 * HOUR, yield: 5, orePrice: 244,
